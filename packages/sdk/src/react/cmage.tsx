...
export const Cmage = forwardRef<HTMLImageElement, CmageProps>(function Cmage(
  { src, projectId, apiKey, baseUrl = process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:4000", version, width, height, quality, format, placeholder, priority, ...rest },
  ref
) {
  const client = new CarcosaClient({ baseUrl, apiKey });
