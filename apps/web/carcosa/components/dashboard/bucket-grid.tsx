  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      {buckets.map((bucket) => (
        ...
        >
          <Card className="group relative overflow-hidden border-0 bg-gradient-to-br from-background to-muted/50 hover:from-muted/50 hover:to-muted transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:ring-2 hover:ring-primary/20">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button
                  ...
                  disabled={
                    deleting === bucket.id || bucket._count.projects > 0
                  }
